...
namespace ApiAcme.Flexcel
{
    public class RelatoriosFlexcelUtilitario
    {
        ...
        public void GerarExcel<T>(IList<T> aLista, string NomeFonte, string aCaminhoTemplate, string aCaminhoArquivoSaida, string aNomeEmpresa)
        {
            try
            {
                ...
                SetReport(aLista, NomeFonte, aNomeEmpresa);
        ...
        private void SetReport<T>(IList<T> aLista, string aNomeFonte, string aNomeEmpresa)
        {
            Report.SetValue("Empresa", aNomeEmpresa);
            Report.SetValue("PaginaXdeY", string.Empty);
            Report.SetValue("DataSistema", DateTime.Now.ToShortDateString());

            Report.AddTable(aNomeFonte, aLista);
